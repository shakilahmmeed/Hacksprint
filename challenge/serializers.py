...
class ChallengeSerializer(serializers.ModelSerializer):
    ...
    def check_join(self, challenge):
        ...
        usr_participations = user.challengesparticipation_set.filter(challenge=challenge)
...
class EndParticipationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ChallengesParticipation
        fields = '__all__'
        extra_kwargs = {'name': {'required': False}, 'challenge': {'required': False}, 'leader': {'required': False}}
